...
class PDFGanttChart
{
    ...
    public function render( $output = true )
    {
        ...
        $style  = file_get_contents( "/var/www/pidsymfony/web/css/pdfganttstyle.css");
...
if (@file_exists('/var/www/pidsymfony/vendor/tecnickcom/tcpdf/lang/eng.php')) {
	require_once('/var/www/pidsymfony/vendor/tecnickcom/tcpdf/lang/eng.php');
...
//============================================================+
        ...
        if( $output ) {
			...
			$pdf->writeHTMLCell(0, 0, '', '', 'hello', 0, 1, 0, true, '', true);

			// ---------------------------------------------------------

			// Close and output PDF document
			// This method has several options, check the source code documentation for more information.
			$pdf->Output('/var/www/pidsymfony/example_001.pdf', 'I');
        } else {
            return implode("\n", $html);
        }
    }
